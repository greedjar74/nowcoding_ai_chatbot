...
def NP_stage_8_1():
    ...
    # system content 설정
    with open(r'system_contents\NP_stage_8_1.txt', 'r', encoding='utf-8') as f:
    ...
    # 설명 prompt
    with open(r'input_contents\NP_stage_8_1.txt', 'r', encoding='utf-8') as f:
        input_prompt = f.read()
    ...
    # Test Case
    with open(r'test_cases\NP_stage_8_1.txt', 'r', encoding='utf-8') as f:
        test_case = f.read()
