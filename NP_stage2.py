...
def NP_stage_2():
    ...
    #1. (‘제약조건’ 설명이 없는 경우 ‘제약조건을 이해할 수 없습니다.’ 문구 출력)<br>
    erase(0, 0)

    #2. (‘제약조건’ 설명이 없는 경우 ‘제약조건을 이해할 수 없습니다.’ 문구 출력)<br>
    erase(0, 0)<br>
    erase(0, 1)<br>
    erase(0, 2)<br>
    erase(0, 3)

    #3. (‘제약조건’ 설명이 없는 경우 ‘제약조건을 이해할 수 없습니다.’ 문구 출력)<br>
    erase(0, 0)<br>
    erase(0, 0)<br>
    erase(0, 0)<br>
    erase(0, 0)
    ...
    #4. (‘제약조건’ 설명이 없는 경우 ‘제약조건을 이해할 수 없습니다.’ 문구 출력)<br>
    for i in range(10):<br>
        &nbsp;&nbsp;&nbsp;&nbsp;erase(0, i)

    #5. (‘제약조건’ 설명이 없는 경우 ‘제약조건을 이해할 수 없습니다.’ 문구 출력)<br>
    for i in range(5):<br>
        &nbsp;&nbsp;&nbsp;&nbsp;erase(0, i)<br>
        &nbsp;&nbsp;&nbsp;&nbsp;erase(i, 0)

    #6. (‘제약조건’ 설명이 없는 경우 ‘제약조건을 이해할 수 없습니다.’ 문구 출력)<br>
    for i in range(5):<br>
        &nbsp;&nbsp;&nbsp;&nbsp;erase(0, i)
